const Text = () => {
  return (
    <section className="polygon-bg min-h-[40vh] md:min-h-[50vh] lg:min-h-[50vh] flex items-center justify-center px-4 sm:px-6 md:px-10">
      <p className="raj-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-center text-white leading-tight sm:leading-snug md:leading-snug max-w-5xl">
        ...
        <span className="bg-gradient-to-r from-[#7E1616] to-[#d88367] bg-clip-text text-transparent">
          Actionable Outcomes 
        </span>{" "}
        <span className="bg-gradient-to-r from-[#EACCC2] to-[#7E1616] bg-clip-text text-transparent">
